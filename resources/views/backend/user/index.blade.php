@extends('backend.layouts.app', ['title' => 'Users', 'menu' => view('backend.user.menu')->render(), 'breadcrumbs' => [
				...
				<div class="card mb-4">
					...
					<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-sm-4 pr-1">
									...
									<div class="input-group input-group mb-1">
										<input type="text" class="form-control" maxlength="50" id="filter-keyword">
						...
						<div class="table-responsive p-0">
							<table class="table align-middle table-row-dashed fs-6 gy-5 no-footer table-hover" id="user-datatable" style="width:100%">
								<thead>
									<tr>
										<th data="id" name="id" width="20px">ID</th>
                                        <th data="full_name" name="full_name">Name</th>
										<th data="email" name="email">Email</th>
