...
@section('content')
    {{ Form::open(['route' => 'user.email-change.verify', 'id' => 'kt_sign_in_form', 'novalidate' => "novalidate", 'class'=>'form w-100', 'method' => 'POST' ]) }}
        {{ Form::hidden('token', $token) }}
        <div class="text-center mb-10">
            <!--begin::Title-->
            <h1 class="text-dark mb-3">
                Please verify your password to confirm email change.
            </h1>
            <!--end::Title-->

            <!--begin::Link-->
            <div class="text-gray-400 fw-bold fs-4">
                You have to <b>(re)login using your new email address</b> after finalise this step.
            </div>
            <!--end::Link-->
        </div>
